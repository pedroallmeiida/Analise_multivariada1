...
- Considere a área gerada dentro do plano por dois vectores de desvio $\mathbf{d}_1=\mathbf{y}_1-{x}_1 \mathbf{1}$ e $\mathbf{d}_2=\mathbf{y}_2-{x}_2 \mathbf{1}$. Que $L_{\mathbf{d}_1}$ seja o comprimento de $\mathbf{d}_1$ e $L_{mathbf{d}_2}$ o comprimento de $\mathbf{d}_2$. Por geometria elementar, temos o diagrama
