...
plot(y1,y1,ylab = "PreÃ§o de vendas em milhares de dÃ³lares", xlab = "Tempo de FabricaÃ§Ã£o em anos")

#Inferir o sinal da amostra de covariÃ¢ncia
cov(y1,y2)
...
#Correlação deu negativa e bastante proxima de -1, o que significa que quanto mais o tempo de fabricaÃ§Ã£o cresce, mais o preÃ§o de venda diminui.
